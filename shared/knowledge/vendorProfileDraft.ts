import type { ProcurementVendorDetail, ProcurementVendorProfile, ProcurementVendorProfileInput, VendorBankAccount, VendorOrganizationType } from "./knowledgeTypes";
