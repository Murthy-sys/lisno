...
const prioritySchema = new Schema(
  ...
  { collection: "aiEstimatorKnowledgePriorities", timestamps: true, versionKey: false, strict: "throw" }
);

prioritySchema.pre("validate", function normalizeMaster() {
...
export const AiEstimatorKnowledgePriorityModel =
  models.AiEstimatorKnowledgePriority ?? model("AiEstimatorKnowledgePriority", prioritySchema);
