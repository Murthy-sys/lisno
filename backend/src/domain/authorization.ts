...
export const ROLE_PERMISSIONS = {
  ...
  procurement: ["identity.self.read", "organization.user_tasks.read", "organization.user_kpi.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel", "workflow.tasks.read", "workflow.tasks.update"],
