...
export const ROLE_PERMISSIONS = {
  super_admin: [
    "identity.self.read", "projects.list", "projects.client_summary.read", "projects.create", "projects.read", "projects.floor.create", "projects.stage.create", "projects.task.create", "design.task_events.read", "design.task.self.update", "design.task_deadline.update", "organization.managers.read", "organization.team.read", "organization.tree.read", "organization.manager_designers.read", "organization.designer_summary.read", "organization.user_tasks.read", "organization.user_kpi.read", "organization.evaluation.create", "organization.evaluation.read", "audit.project_activity.read", "audit.designer.read", "audit.read", "design.client_latest_approved.read", "design.version.upload", "design.version.read", "design.version_extraction.read", "design.version.approve", "design.version.download", "design.section_draft.read", "design.section.create", "design.section.update", "design.section.delete", "design.section_extraction.retry", "design.section.submit", "design.client_sections.read", "design.client_section_decision", "design.source_page_image.read", "design.section_revision_image.read", "estimation.design_upload.create", "estimation.design_upload.read", "estimation.design_upload.retry", "estimation.source_page_image.read", "estimation.drawing.create", "estimation.design_revision_image.read", "estimation.client_drawings.read", "estimation.client_annotation_draft.save", "estimation.client_drawing_decision", "estimation.drawing.update", "estimation.drawing.estimate_item.assign", "estimation.drawing.delete", "estimation.drawing.replace", "estimation.drawing.submit", "estimation.client_plan_review.read", "estimation.client_plan_annotation_draft.save", "estimation.client_plan_target_preview", "estimation.client_plan_change_request.create", "estimation.client_plan_change_request.update", "estimation.plan_change_request.read", "estimation.plan_change_request.targets.update", "estimation.plan_change_request.resolve_page", "estimation.plan_page_image.read", "estimation.lead.list", "estimation.lead.create", "estimation.lead.read", "estimation.lead.update", "estimation.lead_activity.read", "estimation.lead_activity.create", "estimation.estimate.read", "estimation.estimate.list", "estimation.estimate.save", "estimation.estimate.submit", "estimation.estimate_pdf.download", "estimation.review_queue.read", "estimation.assignable_designers.read", "estimation.designer_assignment.create", "estimation.designer_assignment.decision", "estimation.estimate.send_client", "estimation.client_estimate.list", "estimation.client_estimate_pdf.download", "estimation.client_estimate.decision", "identity.authorization.read", "identity.users.read", "identity.users.update", "access_request.create", "access_request.self.read", "access_request.self.cancel", "access_request.review.read", "access_request.review.decide", "project_access_grant.revoke", "execution.worker_assignment.override"
  ],
  admin: ["identity.self.read", "projects.list", "projects.read", "identity.authorization.read", "identity.users.read", "identity.users.update", "access_request.review.read", "access_request.review.decide", "project_access_grant.revoke"],
  estimator_sales: ["identity.self.read", "projects.list", "projects.read", "estimation.design_upload.create", "estimation.design_upload.read", "estimation.design_upload.retry", "estimation.source_page_image.read", "estimation.drawing.create", "estimation.design_revision_image.read", "estimation.drawing.update", "estimation.drawing.estimate_item.assign", "estimation.drawing.delete", "estimation.drawing.replace", "estimation.drawing.submit", "estimation.plan_change_request.read", "estimation.plan_change_request.targets.update", "estimation.plan_change_request.resolve_page", "estimation.plan_page_image.read", "estimation.lead.list", "estimation.lead.create", "estimation.lead.read", "estimation.lead.update", "estimation.lead_activity.read", "estimation.lead_activity.create", "estimation.estimate.read", "estimation.estimate.list", "estimation.estimate.save", "estimation.estimate.submit", "estimation.estimate_pdf.download", "estimation.estimate.send_client", "identity.authorization.read"],
  designer: ["identity.self.read", "projects.list", "projects.create", "projects.read", "projects.floor.create", "projects.stage.create", "projects.task.create", "design.task_events.read", "design.task.self.update", "organization.managers.read", "organization.designer_summary.read", "organization.user_tasks.read", "organization.user_kpi.read", "organization.evaluation.read", "audit.designer.read", "audit.read", "design.version.upload", "design.version.read", "design.version_extraction.read", "design.version.download", "design.section_draft.read", "design.section.create", "design.section.update", "design.section.delete", "design.section_extraction.retry", "design.section.submit", "design.source_page_image.read", "design.section_revision_image.read", "estimation.plan_change_request.read", "estimation.plan_change_request.targets.update", "estimation.plan_change_request.resolve_page", "estimation.plan_page_image.read", "estimation.review_queue.read", "estimation.designer_assignment.decision", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel"],
  procurement: ["identity.self.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel"],
  finance_head: ["identity.self.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel"],
  site_manager: ["identity.self.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel"],
  worker_electrician: ["identity.self.read", "identity.authorization.read"],
  worker_plumber: ["identity.self.read", "identity.authorization.read"],
  worker_carpenter: ["identity.self.read", "identity.authorization.read"],
  worker_painter: ["identity.self.read", "identity.authorization.read"],
  worker_civil: ["identity.self.read", "identity.authorization.read"],
  worker_other: ["identity.self.read", "identity.authorization.read"],
