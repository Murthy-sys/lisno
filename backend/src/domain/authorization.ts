...
export const ROLE_PERMISSIONS = {
  ...
  finance_head: ["identity.self.read", "organization.user_tasks.read", "organization.user_kpi.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel", "finance.bucket.read", "finance.entry.read", "finance.entry.create", "workflow.tasks.read", "workflow.tasks.update"],
