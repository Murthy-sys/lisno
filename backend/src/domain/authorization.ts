...
export const ROLE_PERMISSIONS = {
  ...
  procurement: ["chat.read", "chat.send", "chat.issue", "chat.read_state", "identity.self.read", "organization.user_tasks.read", "organization.user_kpi.read", "identity.authorization.read", "access_request.create", "access_request.self.read", "access_request.self.cancel", "procurement.workspace.read", "procurement.expense.create", "procurement.document.read", "workflow.tasks.read", "workflow.tasks.update"],
