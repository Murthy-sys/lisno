...
export const HUMAN_JWT_OPERATION_LIST = [
  ...
  { key: "PUT /auth/me/profile-photo", permission: "identity.self.profile_photo.manage", scope: { kind: "non_project", namespace: "identity" }, operationClass: "personal", superAdminBehavior: "self", availability: "baseline" },
  { key: "DELETE /auth/me/profile-photo", permission: "identity.self.profile_photo.manage", scope: { kind: "non_project", namespace: "identity" }, operationClass: "personal", superAdminBehavior: "self", availability: "baseline" },
  { key: "GET /users/:userId/profile-photo", permission: "identity.self.read", scope: { kind: "non_project", namespace: "identity" }, operationClass: "read", superAdminBehavior: "global_read", availability: "baseline" },
  ...
  { key: "GET /admin/design-plan-response-tasks/:roundId/proof", permission: "design.plan_response_tasks.read", scope: { kind: "non_project", namespace: "estimate_client_response" }, operationClass: "read", superAdminBehavior: "global_read", availability: "project_workflow" },
  ...
  { key: "GET /procurement/suggestion-projects", permission: "procurement.vendor_suggestions.read", scope: { kind: "non_project", namespace: "project_workflow" }, operationClass: "read", superAdminBehavior: "global_read", availability: "project_workflow" },
  { key: "GET /procurement/projects/:projectId/vendor-suggestions", permission: "procurement.vendor_suggestions.read", scope: { kind: "non_project", namespace: "project_workflow" }, operationClass: "read", superAdminBehavior: "global_read", availability: "project_workflow" },
  { key: "POST /procurement/projects/:projectId/vendor-suggestions", permission: "procurement.vendor_suggestions.manage", scope: { kind: "non_project", namespace: "project_workflow" }, operationClass: "personal", superAdminBehavior: "deny_personal", availability: "project_workflow" },
  { key: "PATCH /procurement/projects/:projectId/vendor-suggestions/:suggestionId", permission: "procurement.vendor_suggestions.manage", scope: { kind: "non_project", namespace: "project_workflow" }, operationClass: "personal", superAdminBehavior: "deny_personal", availability: "project_workflow" },
  { key: "GET /procurement/vendors", permission: "procurement.vendors.read", scope: { kind: "non_project", namespace: "project_workflow" }, operationClass: "read", superAdminBehavior: "global_read", availability: "project_workflow" },
  ...
  { key: "GET /admin/ai-estimator-knowledge/vendors/msme-certificate-upload-policy", permission: "ai_estimator_knowledge.configuration.read", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "read", superAdminBehavior: "global_read", availability: "ai_estimator_knowledge" },
  { key: "POST /admin/ai-estimator-knowledge/vendors/msme-certificate-uploads", permission: "ai_estimator_knowledge.configuration.create", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "POST /admin/ai-estimator-knowledge/vendors/:id/msme-certificate-uploads", permission: "ai_estimator_knowledge.configuration.update", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "GET /admin/ai-estimator-knowledge/vendors/:id/msme-certificate", permission: "ai_estimator_knowledge.configuration.read", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "read", superAdminBehavior: "global_read", availability: "ai_estimator_knowledge" },
  ...
  { key: "GET /admin/ai-estimator-knowledge/baskets/:basketId/quality", permission: "ai_estimator_knowledge.configuration.read", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "read", superAdminBehavior: "global_read", availability: "ai_estimator_knowledge" },
  { key: "GET /admin/ai-estimator-knowledge/quality-control-options", permission: "ai_estimator_knowledge.configuration.read", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "read", superAdminBehavior: "global_read", availability: "ai_estimator_knowledge" },
  { key: "POST /admin/ai-estimator-knowledge/quality-control-options", permission: "ai_estimator_knowledge.quality_control_options.create", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  ...
  { key: "PUT /admin/ai-estimator-knowledge/baskets/:basketId/quality", permission: "ai_estimator_knowledge.configuration.update", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  ...
  { key: "GET /admin/ai-estimator-knowledge/baskets/:basketId/deletion-impact", permission: "ai_estimator_knowledge.configuration.lifecycle", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "GET /admin/ai-estimator-knowledge/baskets/:basketId/sub-baskets", permission: "ai_estimator_knowledge.configuration.read", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "read", superAdminBehavior: "global_read", availability: "ai_estimator_knowledge" },
  ...
  { key: "POST /admin/ai-estimator-knowledge/baskets/:basketId/sub-baskets", permission: "ai_estimator_knowledge.configuration.create", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "PATCH /admin/ai-estimator-knowledge/baskets/:basketId/sub-baskets/:subBasketId", permission: "ai_estimator_knowledge.configuration.update", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "GET /admin/ai-estimator-knowledge/baskets/:basketId/sub-baskets/:subBasketId/deletion-impact", permission: "ai_estimator_knowledge.configuration.lifecycle", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  { key: "DELETE /admin/ai-estimator-knowledge/baskets/:basketId/sub-baskets/:subBasketId", permission: "ai_estimator_knowledge.configuration.lifecycle", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
  ...
  { key: "GET /projects/:projectId/chat/action-types", permission: "chat.read", scope: { kind: "non_project", namespace: "project_chat" }, operationClass: "read", superAdminBehavior: "global_read", availability: "project_chat" },
  { key: "POST /projects/:projectId/chat/action-types", permission: "chat.action_types.manage", scope: { kind: "non_project", namespace: "project_chat" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "project_chat" },
  { key: "PATCH /projects/:projectId/chat/project-name", permission: "chat.project_name.manage", scope: { kind: "non_project", namespace: "project_chat" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "project_chat" },
  { key: "POST /projects/:projectId/chat/participants/:userId/remove", permission: "chat.participants.manage", scope: { kind: "non_project", namespace: "project_chat" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "project_chat" },
  { key: "POST /projects/:projectId/chat/participants/:userId/restore", permission: "chat.participants.manage", scope: { kind: "non_project", namespace: "project_chat" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "project_chat" },
