...
export const HUMAN_JWT_OPERATION_LIST = [
  ...
  { key: "DELETE /admin/ai-estimator-knowledge/baskets/:basketId/permanent", permission: "ai_estimator_knowledge.configuration.lifecycle", scope: { kind: "non_project", namespace: "ai_estimator_knowledge" }, operationClass: "admin", superAdminBehavior: "admin_override", availability: "ai_estimator_knowledge" },
