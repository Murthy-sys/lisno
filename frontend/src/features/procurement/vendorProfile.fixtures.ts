import type { KnowledgeBasket, KnowledgeSubBasket, ProcurementVendorDetail, ProcurementVendorProfile, VendorBankAccount } from "../ai-estimator-knowledge/knowledgeTypes";
...
export const sampleVendorBankAccount: VendorBankAccount = { accountHolderName: "Synthetic Account Holder", bankName: "Synthetic Sample Bank", accountNumber: "00012345006789", ifscCode: "DEMO0123456", branchName: "Synthetic Branch" };
export const completeVendorProfile: ProcurementVendorProfile = {
  ...
  nameOfRepresentative: "Sample Representative", position: "Owner", gstRegistered: false, gstNumber: null, msmeRegistered: false,
...
export const completeVendor: ProcurementVendorDetail = {
  ...
  procurementSummary: { vendorType: "execution", profileComplete: true, currentAddressVerifiedPhysically: false, mainBasket: { id: vendorBasket.id, name: vendorBasket.name, status: "active" }, subBasket: { id: vendorSubBasket.id, name: vendorSubBasket.name } }, geoTaggedPicture: null, msmeCertificate: null
};
