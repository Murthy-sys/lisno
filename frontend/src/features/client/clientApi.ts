...
import type { DesignVersion, PageData, Project, ProjectHierarchy } from "../../api/types";
...
export const getClientVersions = (projectId: string) => getAllPages((offset) => apiClient.get<PageData<DesignVersion>>(`/projects/${encodeURIComponent(projectId)}/design-versions?limit=${PAGE_SIZE}&offset=${offset}`));
