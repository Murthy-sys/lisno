...
export function ChatIcon({ name, color = chatColors.muted, size = 22 }: {
  ...
  return (
    <Svg accessibilityElementsHidden importantForAccessibility="no-hide-descendants" height={size} viewBox="0 0 24 24" width={size}>
      ...
      {name === "close" ? <Path {...common} d="M6.5 6.5l11 11M17.5 6.5l-11 11" /> : null}
      ...
      {name === "list" ? <><Path {...common} d="M9 6.5h11M9 12h11M9 17.5h11" /><Circle cx="4.8" cy="6.5" fill={color} r="1.2" /><Circle cx="4.8" cy="12" fill={color} r="1.2" /><Circle cx="4.8" cy="17.5" fill={color} r="1.2" /></> : null}
      ...
      {name === "paperclip" ? <Path {...common} d="M16.5 7.5v8a4.5 4.5 0 0 1-9 0V6a3 3 0 0 1 6 0v9.2a1.5 1.5 0 0 1-3 0V8" /> : null}
      ...
      {name === "search" ? <><Circle {...common} cx="10.5" cy="10.5" r="6" /><Path {...common} d="m15 15 5 5" /></> : null}
